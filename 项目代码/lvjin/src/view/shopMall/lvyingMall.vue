<template>
  <div class="bg_f5">
    ...
    <div class="center_box">
      <ul class="list_unstyled ul_inline clearfix">
        <li v-for="item in productList" class="listBox bg_white">
          <div class="text_center" @click="jumpDetail(item.productCode)">
            <img :src="item.productProfileUrl" class="all_width" height="280">
          </div>
          <div class="font_18 text_ellipsis margin_top_20 pointer" @click="jumpDetail(item.productCode)">{{item.productTitle}}</div>
...
<style scoped lang='less'>
  ...
  .center_box{
    ...
    .listBox{
      width: 280px;height: 450px;border: 1px solid #e6e6e6;margin: 30px 15px 0 15px;box-sizing: border-box;padding: 20px 10px;
